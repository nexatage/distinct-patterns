                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden lg:flex lg:flex-1 lg:items-center">
                    <a href="#">
                      ...
                      <img
                        alt=""
                        src="https://t4.ftcdn.net/jpg/03/82/30/17/360_F_382301730_NKmrW367nzz6N1iIexa0ITCPlpryQSre.jpg"
                                    ...
                                    {category.featured.map((item) => (
                                      ...
                                      >
                                        <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-100 group-hover:opacity-75">
                                          <img
                                            alt={item.imageAlt}
                           https://t4.ftcdn.net/jpg/03/82/30/17/360_F_382301730_NKmrW367nzz6N1iIexa0ITCPlpryQSre.jpgexa0ITCPlpryQSre.jpgexa0ITCPlpryQSre.jpg
                                            className="object-cover object-center"
                                          />
                                        </div>
                                        <a
